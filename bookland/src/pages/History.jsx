...
const History = () => {
    ...
    {/* Page Header */}
<section
  className="relative min-h-[80vh] sm:min-h-[80vh] bg-center bg-cover mx-auto mb-6 p-8"
  ...
  >
    ...
    <div className="group w-full sm:h-4/6 sm:w-2/6 bg-white/60 md:bg-white/20 p-6 rounded-sm mt-8 md:m-16 text-black pl-8">
      ...
      <ul className="space-y-3 md:text-gray-900 font-semibold">
        <li>
          <a href="#roots" className="hover:underline">
        ...
        <li>
          <a href="#perspectives" className="hover:underline">
            The Rise of Different Perspectives
          </a>
        </li>
        <li>
          <a href="#modern" className="hover:underline">
