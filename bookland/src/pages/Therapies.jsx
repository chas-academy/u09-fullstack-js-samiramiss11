...
>
  <div
    className="absolute inset-0 bg-black/50 flex flex-col /* mobile: stack */ sm:flex-row  /* sm+: row */ sm:items-start /* align top on row */ sm:space-x-12  /* gutter on row */">
    {/* Intro column */}
    <div className="flex-1 space-y-6 p-6 sm:p-16">
      ...
      In this section, we explore three key psychotherapy approaches—Cognitive Behavioral Therapy (CBT), Behavioral Therapy, and Psychoanalysis—and how each guides change: CBT reshapes thoughts, Behavioral Therapy modifies actions, and Psychoanalysis uncovers the unconscious forces that drive behavior.</p>
    </div>
